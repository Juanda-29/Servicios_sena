    ...
    >
      ...
      <q-list class="lista-servicios">
        ...
        >
          ...
          <q-item-section>
            <q-item-label class="texto-servicio">
              {{ item.label }}
            </q-item-label>
          </q-item-section>
...
/* Paleta nueva: verde bosque + terracota + dorado tierra,
   pensada para un centro agroturístico (naturaleza + calidez) */
